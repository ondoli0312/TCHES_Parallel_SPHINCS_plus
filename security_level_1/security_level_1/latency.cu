...
int crypto_sign_signature_security_level_1(uint8_t* sig, size_t* siglen, uint8_t* m, size_t mlen, uint8_t* sk) {
    uint8_t* sk_seed = sk;
...
int main() {
    ...
    //crypto_sign_signature_security_level_1(sig, &siglen, m, SPX_SK_BYTES, sk);
